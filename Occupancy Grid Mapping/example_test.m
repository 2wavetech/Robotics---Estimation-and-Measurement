...
% Each element of myMap specifies the color for 1 pixel of the image. The
% resulting image is an m-by-n grid of pixels where m is the number of
% columns and n is the number of rows in C. The row and column indices of
